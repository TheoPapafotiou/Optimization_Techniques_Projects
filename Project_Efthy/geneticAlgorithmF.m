function [] = geneticAlgorithmF(maxGenerations)
...
plotAnalyticF(resolution, finalGene, chromosomeSize, u1Limits, u2Limits, generation, maxGenerations);
end